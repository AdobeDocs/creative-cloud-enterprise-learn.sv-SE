...
![En 3D CGI-scen på en bil på en parkeringsplats med en neonskylt på väggen. Belysningen skiftar från dagsljus till en neonlampa som strålar ut från skylten](assets/Mastering3dlighting_1.gif)
...
![CGI vardagsrum återger jämförelse med neutralt grått matt material till vänster jämfört med färdiga material till höger](assets/Mastering3dlighting_2.jpg)
...
![Exempel på tre lampor som belyser en 3D-bilmodell individuellt och alla tre fungerar tillsammans](assets/Mastering3dlighting_3.gif)
...
![Använda en spegelboll (en sfär med metallisk textur) för att se och rikta miljöljuset i en 3D-scen](assets/Mastering3dlighting_4.gif)
...
När du skapar en ny scen i [[!DNL Dimension]](https://www.adobe.com/products/dimension.html) skapas en standardmiljöbelysning åt dig. Det är därför du omedelbart kan se något i scenen. Startresurserna för Adobe [!DNL Dimension] innehåller ett visst antal miljöljussättning, som du kan prova direkt. Dessutom har [Adobe [!DNL Stock]](https://stock.adobe.com/search?filters[content_type:3d]=1&amp;filters[3d_type_id][0]=2&amp;load_type=3d+lp) ett stort, utvalt urval av miljöljussättning.
...
![Exempel på en scen där hela uppsättningen (inklusive belysningen) har monterats i 3D för att uppnå studioliknande resultat](assets/Mastering3dlighting_6.jpg)
...
I båda fallen &quot;bakas&quot; ljuskällorna (och deras intensitet) in i de här bilderna och avger ljuset när de har använts i [!DNL Dimension].
...
![Ändra intensiteten och orienteringen för miljöljuset i en 3D-scen](assets/Mastering3dlighting_11.gif)
...
[!DNL Dimension] har en praktisk åtgärd, Syfta ljus vid punkt, som gör att du kan styra rotation och höjd genom att helt enkelt klicka och dra över ett 3D-objekt. På så sätt kan du dynamiskt rikta ljusstrålarna. Dessa parametrar kan också justeras manuellt.
...
![Diagram som visar vilken effekt ljusintensitet, riktning och storlek har på hur ett 3D-objekt lyses upp och vilken skugga det kastar](assets/Mastering3dlighting_13.jpg)

![Exempel på hur storleken på ett 3D-ljus påverkar skuggans mjukhet på grund av en CGI-bilmodell](assets/Mastering3dlighting_14.gif)
...
![En 3D-scen på månen där solljus är den enda ljuskällan](assets/Mastering3dlighting_16.jpg)

Vi kan emulera himlen med hjälp av miljöbelysning, och allt miljöljus som finns på himlen kan användas. Nu måste vi justera solljuset (skapat i [!DNL Dimension]) mot solen, fångat i omgivningsljuset. Ett snabbt sätt att göra detta är att skapa en sfär och tilldela den ett metallmaterial. Detta kommer att ge oss reflektioner av miljön i realtid, så att vi kan använda Riktat ljus vid punkten för att justera solljuset mot solen.
...
![Ljuskälla med utfall (en lysande platta) VS. en oändlig ljuskälla (ett riktat ljus)](assets/Mastering3dlighting_18.png)
...
![Om du ändrar storleken på objektljuset ökar ljusmängden och skuggorna blir mjukare](assets/Mastering3dlighting_19.gif)
...
1. **Rim-ljus:** Detta används för att exponera motivets silhuett. Det är orienterat på motsatt sida från nyckeln.

   ![Exempel på en fälglampa som belyser en 3D-hörlursmodell](assets/Mastering3dlighting_23.jpg)

1. **Fyllnadsljus:** mindre intensivt och används för att fylla i mörkare områden. Det här används för områden som de två föregående lamporna inte når.

   ![Exempel på ett fyllnadsljus som lyser upp en 3D-hörlursmodell](assets/Mastering3dlighting_24.jpg)

Det finns två sätt att skapa 3-punktsbelysning i [!DNL Dimension] - med riktat ljus (som kan läggas till i motivet eller användas med en 3-punktsförinställning) eller via glödande objekt.
...
![3D-konstverk av Vladimir Petkovic med titeln Pipe Dreams](assets/Mastering3dlighting_27.jpg)
...
![En illustration som visar inställningen av 3D-belysning för Vladimir Petkovics Pipe Dreams](assets/Mastering3dlighting_28.jpg)

### Invändig visualisering

![En 3D-interiör i ett vardagsrum](assets/Mastering3dlighting_29.jpg)
...
![En scen med en trädstubbe på ett skogsgolv, sammanflätad med CGI-sladdar och band upplysta med 3D-belysning utomhus](assets/Mastering3dlighting_32.jpg)
...
Glad belysning! Hämta den [senaste versionen](https://creativecloud.adobe.com/apps/download/Dimension) av Dimension i dag.
