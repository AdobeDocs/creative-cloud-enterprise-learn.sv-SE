...
description: Lär dig hur du skapar förbluffande, fotorealistisk virtuell fotografering med 3D-bildkomposition och -rendering i Adobe [!DNL Dimension]
feature: 3D
role: User
...
![Ett kollage av exempel med fotorealistiska virtuella fotografier som har designats med Adobe [!DNL Dimension]](assets/Photorealistic_1.png)
...
![En scen från James Camerons Avgrund där Mary Mastrantonio rör vid CGI-vattentaklet](assets/Photorealistic_2.jpg)

Den här tekniken för att skapa lager eller &quot;sätta samman&quot; 3D-modeller till en bild eller video är inte ny, och dess ursprung går i själva verket tillbaka till de tidiga åren med VFX (så långt tillbaka som på 1980-talet). Det nya och spännande är att den här tekniken har blivit ett kraftfullt verktyg för användare av [Adobe [!DNL Dimension]](https://www.adobe.com/products/dimension.html) och ett spännande nytt arbetsflöde för fotografer.
...
Funktionen Matcha bild analyserar bakgrundsbilden och uppskattar brännvidden och positionen för kameran som användes för att ta bilden. Sedan skapas en 3D-kamera i scenen [!DNL Dimension] som kan användas för att återge 3D-element i samma perspektiv som bakgrundsbilden så att de sätts samman.
...
![Produktbild av Ricoh Theta 360-graderskamera](assets/Photorealistic_7.png)
...
Leta efter platser som är intressanta för både deras kontext och belysning. När du funderar på kontexten kan det vara bra att föreställa sig ett motivs potentiella användning. Du kan till exempel använda en vy av en tom väg för att lägga till i en 3D-bil medan en vy av ett bord på ett kafé kan användas för att [visa matförpackningar](https://www.adobe.com/products/dimension/packaging-design-mockup.html).

![4 platsscener för ett virtuellt foto kontrasteras mot samma scener med en 3D-sammansättning](assets/Photorealistic_8.png)
...
![Ikoner anger den optimala ljusriktningen och fokuspunkten för en bakgrund med virtuella foton](assets/Photorealistic_9.png)
...
![Ta en 360-graderspanoramabild med Ricoh Theta](assets/Photorealistic_10.png)

### Färg

![En 360-graders HDR-panoramabild av ett kontorsutrymme med ett färgdiagram i förgrunden](assets/Photorealistic_11.png)
...
![Menyn för filval Lägg samman till HDR Pro i Adobe Photoshop](assets/Photorealistic_13.png)
...
![Förhandsgranskningsskärmen Lägg samman till HDR Pro i Adobe Photoshop](assets/Photorealistic_14.png)

![Konfigurationsinställningarna för Lägg samman till HDR Pro i Adobe Photoshop](assets/Photorealistic_15.png)
...
![Ett 360-graders HDR-panorama av ett kontorsutrymme med synliga skuggor vid den lägsta nivån](assets/Photorealistic_16.png)

Resultatet är en HDR-bild som kan användas för att belysa scener i 3D.

![Ett 360-graders HDR-panorama av ett kontorsutrymme med synliga skuggor vid den lägsta nivån](assets/Photorealistic_17.png)
...
![Ett diagram som visar potentiella kameravinklar för bakgrundsbilden i ett virtuellt foto](assets/Photorealistic_19.png)
...
När dessa element har samlats och slutförts kan de nu sättas samman i en scen i Adobe [!DNL Dimension]. Det är lika enkelt som att dra bakgrunden in i motivet, där den sedan ska användas på bakgrunden. Lägg sedan till HDR-panoramat i miljöns ljusplats.
...
![Du kan välja bakgrundsbilden för ett virtuellt foto på egenskapsmenyn i Adobe [!DNL Dimension]](assets/Photorealistic_20.png)

Lägg till HDR-panoramat genom att välja Miljöljus och lägga till det i bildindata.

![Miljöljuskällan kan läggas till i bakgrundsbilden för ett virtuellt foto från menyn Scen i Adobe [!DNL Dimension]](assets/Photorealistic_21.png)
...
![Använda funktionen Matcha bild i Adobe [!DNL Dimension] för att återge en 3D-metallsfär med miljöbelysning från ett HDR-panorama](assets/Photorealistic_22.png)
...
Om du snabbt vill bedöma orientering och exponering för HDR-panoramat i förhållande till bakgrunden kan en sfär som är primitiv med ett metallmaterial, hämtad från den kostnadsfria resurspanelen i [!DNL Dimension], placeras i scenen. Miljöljusets rotation kan sedan placeras så att reflektionerna ser korrekta ut. Om ljuset från HDR-panoramat över eller under exponerar sfären bör HDR-panoramans exponering ökas eller minskas för att kompensera.

![Ett fotorealistiskt virtuellt foto av en metallsfär har satts samman till en bakgrundsbild av kontorsutrymmet](assets/Photorealistic_23.png)

Om du snabbt vill bedöma orientering och exponering för HDR-panoramat i förhållande till bakgrunden kan en sfär som är primitiv med ett metallmaterial, hämtad från den kostnadsfria resurspanelen i [!DNL Dimension], placeras i scenen. Miljöljusets rotation kan sedan placeras så att reflektionerna ser korrekta ut. Om ljuset från HDR-panoramat över eller under exponerar sfären bör HDR-panoramans exponering ökas eller minskas för att kompensera.

## Slutresultatet: En fotorealistisk sammansatt bild

![Tidsfördröjning av komposition och rendering av 3D för ett virtuellt produktfoto i Adobe [!DNL Dimension]](assets/Photorealistic_24.gif)

När scenen är klar är arbetsflödet för slutanvändaren okomplicerat. Dra och släpp din modell eller valfritt [Adobe [!DNL Stock] 3D](https://stock.adobe.com/3d-assets)-innehåll direkt i bilden för att återge det som om det fanns där när fotot togs. Detta öppnar nya möjligheter att skapa mycket realistiskt annonsinnehåll, eller möjligheten att upprepa design i många olika sammanhang.

![Fotorealistiskt virtuellt foto av 3D-apparater satt i en köksbänk](assets/Photorealistic_25.png)

Slutresultatet är en övertygande kombination av verklighet och 3D som hjälper slutanvändarna att uppnå målet att skapa fotorealistiska bilder på ett enkelt sätt. Prova själv med några [kostnadsfria [!DNL Dimension] scener](https://assets.adobe.com/public/3926726a-2a17-43d4-4937-6d84a4d29338) som vi har skapat för att visa arbetsflödet.

[Hämta den senaste versionen](https://creativecloud.adobe.com/apps/download/dimension) av [!DNL Dimension] i dag och börja skapa fotorealistiska bilder.
